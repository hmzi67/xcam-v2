            ...
            <div className="container mx-auto px-4 py-16 max-w-7xl">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full mb-6">
                        ...
                        <span className="text-sm text-purple-300">Premium Token Packages</span>
                    </div>
                    ...
                    <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
                        Unlock premium features with our token packages. Get exclusive access to streams, private messaging, and special perks.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
                    ...
                    <Card
                        ...
                        className={`cursor-pointer bg-gray-800/30 backdrop-blur-sm rounded-2xl overflow-hidden transition-all ${selectedPlan === "free"
                    ...
                    >
                        ...
                        <CardContent className="space-y-3 pb-8">
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-gray-400">Limited access to public streams</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-gray-500" />
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-gray-500" />
                                <span className="text-sm text-gray-400">Basic community access</span>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    >
                        <CardHeader className="pb-8 pt-8">
                            <div className="flex items-center justify-between mb-6">
                                <CardTitle className="text-2xl font-semibold text-white">Basic</CardTitle>
                            ...
                            <div className="mb-2">
                                ...
                                <span className="text-base text-gray-400 ml-2">USD / month</span>
                            </div>
                            <div className="text-sm text-gray-500 mb-6">
                                <span className="text-purple-400 font-medium">10 tokens</span> included
                            </div>
                            <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white rounded-xl py-6 font-semibold shadow-lg shadow-purple-500/20 transition-all group-hover:shadow-purple-500/30">
                                Get Basic
                            </Button>
                        </CardHeader>
                        <CardContent className="space-y-3 pb-8">
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-gray-300">Access to all public streams</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Send private messages</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Tip creators & buy gifts</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Custom profile badge</span>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    >
                        ...
                        <CardHeader className="pb-8 pt-8">
                            ...
                            <div className="mb-2">
                                <span className="text-5xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">$15</span>
                                <span className="text-base text-gray-400 ml-2">USD / month</span>
                            </div>
                            <div className="text-sm text-gray-500 mb-6">
                                <span className="text-purple-300 font-medium">50 tokens</span> included
                            </div>
                            <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white rounded-xl py-6 font-semibold shadow-xl shadow-purple-500/30 transition-all group-hover:shadow-purple-500/40">
                                Get Plus
                            </Button>
                        </CardHeader>
                        <CardContent className="space-y-3 pb-8">
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-white font-medium">Everything in Basic</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-300" />
                                <span className="text-sm text-gray-300">Exclusive GOLD show access</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-300" />
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-300" />
                                <span className="text-sm text-gray-300">Special badges & rewards</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-300" />
                    ...
                    >
                        <CardHeader className="pb-8 pt-8">
                            ...
                            <div className="text-sm text-gray-500 mb-6">
                                <span className="text-purple-400 font-medium">200 tokens</span> included
                            </div>
                            <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white rounded-xl py-6 font-semibold shadow-lg shadow-purple-500/20 transition-all group-hover:shadow-purple-500/30">
                                Get Pro
                            </Button>
                        ...
                        <CardContent className="space-y-3 pb-8">
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-white font-medium">Everything in Plus</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Unlimited private messages</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Early access to features</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Exclusive Pro badge</span>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="w-5 h-5 mt-0.5 flex-shrink-0 text-purple-400" />
                                <span className="text-sm text-gray-300">Custom chat colors</span>
                            </div>
                        </CardContent>
                    </Card>
                </div>
                ...
                <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-10 border border-gray-700/50 max-w-5xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed">
                            Tokens are consumed based on the features and services you use. Here's a breakdown of token costs for different actions.
                        </p>
                    </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-700/50">
                                    <th className="text-left py-4 px-4 font-semibold text-purple-300">Model</th>
                                    <th className="text-left py-4 px-4 font-semibold text-purple-300">Rendering</th>
                                    <th className="text-left py-4 px-4 font-semibold text-purple-300">Credits</th>
                                </tr>
                            </thead>
                            <tbody className="text-gray-300">
                                <tr className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                    <td className="py-4 px-4 font-medium text-white" rowSpan={3}>Private Message</td>
                                ...
                                <tr className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                    ...
                                    <td className="py-4 px-4">
                                        <span className="text-purple-400 font-medium">2 tokens</span>
                                        <span className="text-gray-500 text-sm ml-2">/ message</span>
                                    </td>
                                </tr>
                                <tr className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                    ...
                                    <td className="py-4 px-4">
                                        <span className="text-purple-400 font-medium">3 tokens</span>
                                        <span className="text-gray-500 text-sm ml-2">/ message</span>
                                    </td>
                                </tr>

                                <tr className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                    <td className="py-4 px-4 font-medium text-white" rowSpan={2}>Tip Creator</td>
                                ...
                                <tr className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                    ...
                                    <td className="py-4 px-4">
                                        <span className="text-purple-400 font-medium">5 tokens</span>
                                        <span className="text-gray-500 text-sm ml-2">/ tip</span>
                                    </td>
                                </tr>
                                ...
                                <tr className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                    <td className="py-4 px-4 font-medium text-white">GOLD Show</td>
                                ...
                                <tr className="hover:bg-gray-700/20 transition-colors">
                                    <td className="py-4 px-4 font-medium text-white">VIP Support</td>
                                    <td className="py-4 px-4 text-gray-400">24/7 Priority</td>
                                    <td className="py-4 px-4">
                                        <span className="text-green-400 font-medium">Included in Pro</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div className="mt-8 p-4 bg-purple-500/10 border border-purple-500/20 rounded-xl">
                        <p className="text-sm text-gray-400 text-center">
                            <span className="text-purple-300 font-medium">Pro Tip:</span> Tokens never expire and can be used across all features. Buy more to unlock better value!
                        </p>
                    </div>
                </div>
            </div>
